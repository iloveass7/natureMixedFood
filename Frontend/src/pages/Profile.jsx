...
if (!user) {
  ...
  return (
    <div className="mb-6 bg-gradient-to-br from-white to-green-100 flex justify-center items-center p-4 sm:p-6">
      {/* Main Container - Only adjust max-width for smaller screens */}
      <div className="mx-auto w-full max-w-7xl my-6 pb-4 bg-white rounded-3xl shadow-lg overflow-hidden">
        {/* Header - Only adjust padding for smaller screens */}
        ...
        {/* Profile Section - Adjust layout for mobile but keep lg layout */}
        <div className="px-4 sm:px-6 lg:px-10 py-6 sm:py-8 lg:py-10 flex flex-col items-center lg:flex-row lg:items-start gap-6 lg:gap-10">
          {/* Profile Image - Adjust size for mobile */}
          <img
          ...
          {/* User Info - Center on mobile, left-align on lg */}
          ...
          {/* Edit Button - Position adjustments for mobile */}
        ...
        {isEditing && (
          ...
          >
            ...
            <div className="md:col-span-2 flex justify-center lg:justify-end mt-4">
              <button
                type="submit"
                className="bg-green-700 hover:bg-amber-400 text-white text-base sm:text-lg lg:text-lg font-semibold px-4 sm:px-6 py-1 sm:py-2 rounded transition disabled:opacity-50"
                disabled={loading}
              >
        ...
        {/* Static Info - Adjust grid for mobile */}
        {!isEditing && (
...
// InputField component with responsive adjustments
const InputField = ({
  label,
  name,
  value,
  ...
  <div>
    <label className="block text-base sm:text-lg lg:text-lg font-medium text-green-700 mb-1 sm:mb-2">
      {label}
    </label>
    <input
      type={type}

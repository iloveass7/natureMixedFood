...
const InfoCardsSection = () => {
  return (
    <section className="px-4 md:px-20 lg:px-40 py-10">
      ...
      {/* Match products slider gutters on sm/md */}
      <div className="px-1 sm:px-2 pb-4 mb-12">
        <Swiper
          spaceBetween={16}                // same as gap-4
          slidesPerView={1}
          breakpoints={{
            640: { slidesPerView: 2 },
        ...
        >
          {/* Card 1 */}
          <SwiperSlide>
            <div className="mx-1 sm:mx-2 h-90 bg-white shadow-md rounded-lg p-6 hover:shadow-xl hover:-translate-y-2 transition transform flex flex-col items-center justify-center text-center">
